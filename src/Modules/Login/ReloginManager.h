...
class ReloginTimer : public logic::ITimerEvent
{
    friend class ReloginManager;
public:
    ReloginTimer(ReloginManager* pManager);
    virtual void execute(logic::ILogic* pLogic);
    virtual void release();
    
private:
    ReloginManager*             m_pManager;
};
