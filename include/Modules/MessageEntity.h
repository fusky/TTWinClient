/*******************************************************************************
 *  @file      SessionChatMsg.h 2014\7\25 22:59:38 $
...
///////////////////////////消息类型跟服务器一致///////////////////////////////////////////////
#define MSG_TYPE_FLAG_P2P       0x00
#define MSG_TYPE_FLAG_GROUP     0x10

enum MSG_TYPE_SERVER{
	MSG_TYPE_TEXT_P2P = MSG_TYPE_FLAG_P2P + 0x01,
	MSG_TYPE_AUDIO_P2P = MSG_TYPE_FLAG_P2P + 0x02,
	MSG_TYPE_TEXT_GROUP = MSG_TYPE_FLAG_GROUP + 0x01,
	MSG_TYPE_AUDIO_GROUP = MSG_TYPE_FLAG_GROUP + 0x02,
};
...
public:
	...
	UInt8			msgFromType;		//消息来源		 1.个人消息；2.群消息		MSG_TYPE_FROM
